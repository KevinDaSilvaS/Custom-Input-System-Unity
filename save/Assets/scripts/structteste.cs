...
using System.IO;
public class structteste : MonoBehaviour {
    ...
    void Start()
    {
        ...
        print("tecla salva foi" + m_SetCode);
        if (m_SetCode != null)
        {
            textobotao1.text=m_SetCode.ToString();
        }
    }
 ...
 public void selecionartecla(){
     ...
     print("movimentar cima selecionou a tecla: "+ m_SetCode);
 ...
 void save(){
        ...
        playerData.teclaselecionada=m_SetCode;
	}

    void carrega(){
		string jsonstring=File.ReadAllText(FilePath);
		playerData = JsonUtility.FromJson<Custom_Input_Data>(jsonstring);
        m_SetCode=playerData.teclaselecionada;
    ...
    private KeyCode FindKeyDown()
     {
       ...
       if (Input.GetKeyDown(KeyCode.Mouse0)) return m_SetCode;
       /*KeyCode.Mouse0*/
